...
const FormikWrapper = () => {
  ...
  useEffect(() => {
    ...
    wrapText(ctx2, `在疫情下，食肆外賣大增，署方居然未有訂立實施第二階段的確實時間表， 期望政府勿再虛耗光陰。署方須承諾第二階段推前至2025年實施，在減廢路上急起直追。`, 0, 60, 400, 12);
    ...
    wrapText(ctx4, `署方須積極推動及協助業界提供可重用餐具租借配套，同時訂立清晰時間表及各階段目標， 真正落實並鼓勵市民在日常生活中使用可重用餐具，避免因管制即棄塑膠餐具而增加其他即棄餐具 （如：紙、竹）的垃圾量，
    達至真正源頭減廢。`, 0, 60, 400, 16);
