...
const ConsultationForm = withFormik({
  ...
  handleSubmit: (values, { setSubmitting, setStatus, props }) => {
     ...
     */
    doc.addImage(
      `${process.env.PUBLIC_URL}/assets/p27.jpg`,
      'JPEG',
      0,
      0,
      width,
    ...
    doc.addImage(
      `${process.env.PUBLIC_URL}/assets/tick.png`,
      'PNG',
      25,
      101,
      5,
    ...
    doc.addPage()
    doc.addImage(
      `${process.env.PUBLIC_URL}/assets/p28.png`,
      'PNG',
      0,
      0,
      width,
    ...
    doc.addPage()
    doc.addImage(
      `${process.env.PUBLIC_URL}/assets/p29.png`,
      'PNG',
      0,
      0,
      width,
    ...
    doc.addPage()
    doc.addImage(
      `${process.env.PUBLIC_URL}/assets/p30.png`,
      'PNG',
      0,
      0,
      width,
